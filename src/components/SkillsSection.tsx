  ...
  return (
    <div className="w-full h-full flex flex-col justify-center items-center px-6 md:px-12 lg:px-24 text-white overflow-hidden bg-[#0d0d0d]">
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[60vw] h-[60vh] bg-[#ff4f1d]/5 rounded-full blur-[120px] mix-blend-screen opacity-50 transform-gpu will-change-transform"></div>
      </div>
        ...
        <div className="flex flex-col items-start gap-4">
          ...
          <FadeIn delay={0.1}>
            <h1 className="text-4xl md:text-6xl lg:text-7xl font-display font-black leading-none tracking-tight text-white uppercase">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#ff4f1d] to-orange-400">SKILLS</span>
            </h1>
          </FadeIn>
          <FadeIn delay={0.2}>
            ...
            <div className="w-full">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pointer-events-auto"
                >
